      ...
      <div className="bg-white rounded-lg border border-[#e2e8f0]">
        <div className="flex items-center border-b border-[#e2e8f0] px-4">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-3 text-sm font-medium border-b-2 -mb-px transition-colors ${activeTab === "cash" ? "border-green-600 text-green-700" : "border-transparent text-slate-500 hover:text-slate-700"}`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-3 text-sm font-medium border-b-2 -mb-px transition-colors ${activeTab === "bank" ? "border-green-600 text-green-700" : "border-transparent text-slate-500 hover:text-slate-700"}`}
          >
                      ...
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <div className="flex gap-1">
                          <button
                            ...
                            className="p-1 text-slate-400 hover:text-green-600 hover:bg-green-50 rounded text-xs"
